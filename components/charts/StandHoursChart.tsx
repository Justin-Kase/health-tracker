...
interface StandHoursChartProps {
  data: Array<{ date: string; hours: number }>;
}

export default function StandHoursChart({ data }: StandHoursChartProps) {
  if (!data || data.length === 0) return null;

  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 shadow-lg">
      <h2 className="text-xl font-bold text-white mb-4">🧍 Stand Hours</h2>
